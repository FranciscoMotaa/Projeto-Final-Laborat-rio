  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.submenuContainer}>
              ...
              >
                <Ionicons name="battery-charging-outline" size={24} color="#2e7d32" />
                <Text style={styles.submenuLabel}>Bateria</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={styles.submenuLabel}>Carregamento</Text>
              </TouchableOpacity>
            </View>
    </SafeAreaView>
  )
